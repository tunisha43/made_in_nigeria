              ...
              },
              {
                ...
                panel: (
                  <div className="empty-state" style={{ marginTop: 24 }}>
                    Filtering by Verified — connect the live database to populate this view with real verified businesses.
                  </div>
                ),
              },
              {
                ...
                panel: (
                  <div className="empty-state" style={{ marginTop: 24 }}>
                    Not enough real activity data yet to show a Trending list. Trending will populate honestly once usage data exists.
                  </div>
                ),
              },
              {
                ...
                panel: (
                  <div className="empty-state" style={{ marginTop: 24 }}>
                    Newly added businesses will appear here the moment they complete registration.
                  </div>
                ),
              },
            ]}
